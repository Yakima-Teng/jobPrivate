<template>
  <div class="preview-card">
    <div class="card-box" v-show="tabIndex == 0">
      <nav v-if="cardInfo">
          <div class="banner"><img v-if="cardInfo.banner" :src="'../assets/images/preview/wap_'+cardInfo.banner+'.jpg'" /><img v-else src="../assets/images/preview/wap_1.jpg" /></div>
...
.preview-card{ width: 16rem; margin: auto; overflow: hidden;
  nav{ width: 100%; padding-bottom: 1rem; background-color: #fff; overflow: hidden;
    ...
    .grxx{ position: relative; width: 14.5rem; padding: 0.75rem; margin: 1.5rem auto 0;border-radius: 0.25rem; background-color: #fff; box-shadow: 0px 0px 0.25rem rgba(0, 0, 0, 0.349019607843137); box-sizing: border-box;
  ...
  .list{ position: fixed; left: 0; bottom: 0; display: flex; flex-direction: row; width: 100%;
