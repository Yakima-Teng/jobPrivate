...
<div class="preview">
  <div class="w1190">
    ...
    <div class="show-main">
      <div class="top-nav" v-if="cardInfo">
          <a href="javascript:void(0);" class="cur">PC版</a>
          <router-link to="/member/myCard/wap">手机版</router-link>
          <!-- <a href="javascript:void(0);">小程序</a> -->
          <router-link v-if="cardInfo" target="_blank" :to="'/c/'+cardInfo.short">预览</router-link>
      </div>
      <preview-pc-card @setCardInfo="setCardInfo"></preview-pc-card>
    </div>
  </div>
...
import previewPcCard from '@/views/preview-pc-card'
