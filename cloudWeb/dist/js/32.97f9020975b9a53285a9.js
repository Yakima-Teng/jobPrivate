...
var update = add("7a0271f2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"optionsId\":\"0\",\"vue\":true,\"id\":\"data-v-549f8d4a\",\"scoped\":true,\"sourceMap\":false}!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./userInfo.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"optionsId\":\"0\",\"vue\":true,\"id\":\"data-v-549f8d4a\",\"scoped\":true,\"sourceMap\":false}!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./userInfo.vue");
...
// module
exports.push([module.i, "\n.user-head[data-v-549f8d4a]{font-size:16px;color:#333;font-weight:700;padding:28px 0 14px 42px;border-bottom:1px solid #eee;background:#fff;width:1040px;box-sizing:border-box;margin-top:10px\n}\n.user-cont[data-v-549f8d4a]{padding:80px 110px;background:#fff;margin-bottom:80px\n}\n.user-cont h6[data-v-549f8d4a]{float:left;width:64px;font-size:14px;color:#666;margin-right:20px;height:34px;line-height:34px\n}\n.user-cont div~div[data-v-549f8d4a]{margin-top:30px\n}\n.user-cont .step[data-v-549f8d4a]{font-size:12px;position:relative;left:85px\n}\n.user-cont .step.err[data-v-549f8d4a]{color:#e52e3a\n}\n.user-cont .step.sus[data-v-549f8d4a]{color:#34bb45\n}\n.user-cont .h-portrait[data-v-549f8d4a]{position:relative\n}\n.user-cont .h-portrait p[data-v-549f8d4a]{float:left;padding-top:96px;font-size:14px;color:#999;margin-left:16px\n}\n.user-cont .username h6[data-v-549f8d4a]{position:relative\n}\n.user-cont .username h6 span[data-v-549f8d4a]{position:absolute;left:-14px;color:#e52e3a;font-size:12px;top:13px\n}\n.user-cont .username input[data-v-549f8d4a]{width:320px;height:34px;line-height:34px;border:1px solid #e5e5e5;float:left;padding-left:10px\n}\n.user-cont .username p[data-v-549f8d4a]{float:left;font-size:14px;color:#999;margin-top:12px;margin-left:16px\n}\n.user-cont .usersex input[data-v-549f8d4a]{margin-left:40px;position:relative;top:2px\n}\n.user-cont .usersex span[data-v-549f8d4a]{margin-left:10px;font-size:14px;color:#333;line-height:34px\n}\n.user-cont .region[data-v-549f8d4a]{position:relative\n}\n.user-cont .region select[data-v-549f8d4a]{width:98px;height:34px;border:1px solid #e5e5e5\n}\n.user-cont .region span[data-v-549f8d4a]{font-size:15px;position:absolute;top:10px;color:#666;background:#fff;display:inline-block;width:75px\n}\n.user-cont .region span[data-v-549f8d4a]:nth-child(3){left:89px\n}\n.user-cont .region span[data-v-549f8d4a]:nth-child(5){left:192px\n}\n.user-cont .region span[data-v-549f8d4a]:nth-child(7){left:295px\n}\n.user-cont .user-address input[data-v-549f8d4a],.user-cont .user-mail input[data-v-549f8d4a]{width:400px;height:34px;line-height:34px;border:1px solid #e5e5e5;padding-left:10px\n}\n.user-cont button[data-v-549f8d4a]{outline:none;border:none;width:84px;height:32px;line-height:32px;font-size:16px;cursor:pointer;color:#fff;background:#e52e3a;margin-top:40px;margin-left:100px;display:block\n}\n.user-cont button[data-v-549f8d4a]:hover{background:#ff3341\n}", ""]);
...
// add the styles to the DOM
var add = __webpack_require__(147).default
var update = add("6b4edca7", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"optionsId\":\"0\",\"vue\":true,\"scoped\":false,\"sourceMap\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!./userInfo.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"optionsId\":\"0\",\"vue\":true,\"scoped\":false,\"sourceMap\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!./userInfo.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
var render = function() {
  ...
  return _c("div", { staticClass: "container" }, [
    _c("p", { staticClass: "user-head" }, [_vm._v("个人资料")]),
    _vm._v(" "),
    _c("div", { staticClass: "user-cont" }, [
      _c(
        "div",
        { staticClass: "h-portrait clearfix" },
        [
          _c("h6", [_vm._v("头     像 :")]),
          _vm._v(" "),
          _c(
          ...
          _vm._v(" "),
          _c("p", [_vm._v("仅支持jpg、jpeg格式，文件小于2M")])
        ],
        1
      ),
      _vm._v(" "),
      _c("div", { staticClass: "username clearfix" }, [
        _vm._m(0),
        _vm._v(" "),
        _c("input", {
          directives: [
      ...
      _vm._v(" "),
      _c("div", { staticClass: "usersex clearfix" }, [
        _c("h6", [_vm._v("性     别 :")]),
        _vm._v(" "),
        _c("input", {
          directives: [
          ...
          domProps: { checked: _vm._q(_vm.gender, "1") },
          on: {
        ...
        _c("input", {
          ...
          domProps: { checked: _vm._q(_vm.gender, "2") },
          on: {
            change: function($event) {
              _vm.gender = "2"
            }
        ...
        _c("input", {
          ...
          attrs: { type: "radio", name: "sex", value: "3" },
          domProps: { checked: _vm._q(_vm.gender, "3") },
          on: {
            change: function($event) {
              _vm.gender = "3"
            }
      ...
      _vm._v(" "),
      _c("div", { staticClass: "birthday clearfix" }, [
        _c("h6", [_vm._v("生     日 :")]),
        _vm._v(" "),
        _c(
          "div",
          ...
          [
            _c("el-date-picker", {
              ...
              model: {
                value: _vm.birthdayVal,
                callback: function($$v) {
                  _vm.birthdayVal = $$v
                },
                expression: "birthdayVal"
              }
            })
          ],
          1
      ...
      _vm._v(" "),
      _c("div", { staticClass: "user-address clearfix" }, [
        _c("h6", [_vm._v("详细地址:")]),
        _vm._v(" "),
        _c("input", {
          directives: [
      ...
      _vm._v(" "),
      _c("div", { staticClass: "user-mail clearfix" }, [
        _c("h6", [_vm._v("邮     箱 :")]),
        _vm._v(" "),
        _c("input", {
          directives: [
      ...
      _vm._v(" "),
      _c("button", { on: { click: _vm.sub } }, [_vm._v("确定")])
    ])
  ])
}
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("h6", [_vm._v("用 户 名 :"), _c("span", [_vm._v("*")])])
  }
]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-549f8d4a", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_userInfo_vue__ = __webpack_require__(852);
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_549f8d4a_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_userInfo_vue__ = __webpack_require__(1273);
...
/* scopeId */
var __vue_scopeId__ = "data-v-549f8d4a"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null

var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_userInfo_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_549f8d4a_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_userInfo_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_549f8d4a_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_userInfo_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src\\components\\user\\userInfo.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-549f8d4a", Component.options)
  } else {
    hotAPI.reload("data-v-549f8d4a", Component.options)
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__static_js_api_js__ = __webpack_require__(148);
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        ...
        getUserinfo: function getUserinfo() {
            ...
            //获取用户信息
            __WEBPACK_IMPORTED_MODULE_2__static_js_api_js__["a" /* default */].getUserInfo().then(function (res) {
                console.log(res);
                if (res.data.code == 200) {
                    _this.imageUrl = res.data.data.header_img;
                    _this.birthdayVal = res.data.data.birthday;
                    ...
                    _this.oredername = res.data.data.username;
                    _this.select.province = res.data.data.province;
                    _this.select.city = res.data.data.city;
                    _this.select.area = res.data.data.area;
                }
            });
        },
        setUserinfo: function setUserinfo() {
            ...
            __WEBPACK_IMPORTED_MODULE_2__static_js_api_js__["a" /* default */].setUserInfo(data).then(function (res) {
                if (res.data.code == 200) {
                    _this2.$message({
                        message: '恭喜你，修改成功',
                        type: 'success',
        ...
        checkUserName: function checkUserName() {
            ...
            if (this.oredername != this.username) {
                __WEBPACK_IMPORTED_MODULE_2__static_js_api_js__["a" /* default */].checkuserName(this.username).then(function (res) {
                    console.log(res);
                    if (res.data.code == 504) {
                        _this3.stepMsg = res.data.msg;
