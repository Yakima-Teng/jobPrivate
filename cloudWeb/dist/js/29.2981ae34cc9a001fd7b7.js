...
var update = add("98ded654", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"optionsId\":\"0\",\"vue\":true,\"id\":\"data-v-243412c3\",\"scoped\":true,\"sourceMap\":false}!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./contract.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"optionsId\":\"0\",\"vue\":true,\"id\":\"data-v-243412c3\",\"scoped\":true,\"sourceMap\":false}!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./contract.vue");
...
// module
exports.push([module.i, "\n.contract-head[data-v-243412c3]{font-size:16px;color:#333;font-weight:700;padding:28px 0 14px 42px;border-bottom:1px solid #eee;margin-top:10px\n}\n.contract-body[data-v-243412c3],.contract-head[data-v-243412c3]{background:#fff;width:1040px;box-sizing:border-box\n}\n.contract-body[data-v-243412c3]{min-height:600px;padding:20px;position:relative\n}\n.contract-body .add-cont[data-v-243412c3]{height:55px;padding-top:6px;padding-left:20px\n}\n.contract-body .add-cont button[data-v-243412c3]{outline:none;border:1px solid #e52e3a;color:#e52e3a;background:#fff;cursor:pointer;width:98px;height:28px;font-size:14px\n}\n.contract-body .add-cont button[data-v-243412c3]:hover{background:#ff3341;color:#fff\n}\n.contract-body .contract-cont[data-v-243412c3]{min-height:600px\n}\n.contract-body .contract-info[data-v-243412c3]{margin-top:10px;font-size:14px;color:#999;padding:30px 20px 30px 38px;border:1px solid #eee;width:470px;box-sizing:border-box;height:302px;position:relative;float:left;margin-left:20px\n}\n.contract-body .contract-info p em[data-v-243412c3]{display:inline-block;width:84px\n}\n.contract-body .contract-info p var[data-v-243412c3]{padding:0 6px\n}\n.contract-body .contract-info p span[data-v-243412c3]{color:#333\n}\n.contract-body .contract-info p.addr span[data-v-243412c3]{display:inline-block;width:278px;white-space:nowrap;text-overflow:ellipsis;word-break:break-all;overflow:hidden\n}\n.contract-body .contract-info p~p[data-v-243412c3]{margin-top:18px\n}\n.contract-body .contract-info i[data-v-243412c3]{position:absolute;background:url(" + escape(__webpack_require__(710)) + ") -41px 0 no-repeat;width:12px;height:12px;top:21px;right:20px;cursor:pointer\n}\n.contract-body .contract-info .operation[data-v-243412c3]{position:absolute;right:20px;bottom:30px\n}\n.contract-body .contract-info .operation span[data-v-243412c3]{margin-left:14px;font-size:12px;color:#4685c3;cursor:pointer\n}\n.contract-body .contract-info .operation span[data-v-243412c3]:hover{color:#e52e3a\n}\n.contract-body .contract-info .operation span.default[data-v-243412c3]{cursor:default;color:#d3d3d3\n}\n.adv[data-v-243412c3]{margin-top:20px;margin-bottom:20px\n}\n.mask[data-v-243412c3]{top:0;left:0;width:100%;height:100%;background:#7d7d7d;opacity:.7;z-index:5\n}\n.mask[data-v-243412c3],.pop[data-v-243412c3]{position:fixed\n}\n.pop[data-v-243412c3]{width:474px;padding:22px 42px;border-radius:10px;top:50%;left:50%;transform:translateX(-50%) translateY(-50%);z-index:7;background:#fff\n}\n.pop h5[data-v-243412c3]{font-size:26px;color:#333;margin-bottom:30px\n}\n.pop P[data-v-243412c3]{color:#666;font-size:14px;height:52px\n}\n.pop P.spe span[data-v-243412c3]{margin-left:16px\n}\n.pop P select[data-v-243412c3]{width:98px;height:36px;border:1px solid #e5e5e5\n}\n.pop P strong[data-v-243412c3]{font-size:12px;color:#e52e3a;margin-left:129px;font-weight:400\n}\n.pop P strong em[data-v-243412c3]{margin-right:9px;position:relative;top:2px\n}\n.pop P select~select[data-v-243412c3]{margin-left:9px\n}\n.pop P em[data-v-243412c3]{color:#e52e3a;font-size:12px;margin-right:9px;position:relative;top:1px\n}\n.pop P span[data-v-243412c3]{display:inline-block;height:38px;line-height:38px;width:84px\n}\n.pop P var[data-v-243412c3]{padding-left:5px;padding-right:16px\n}\n.pop P var.speVar[data-v-243412c3]{padding-right:12px\n}\n.pop P input[data-v-243412c3]{color:#333;width:320px;box-sizing:border-box;height:38px;line-height:38px;border:1px solid #e5e5e5;padding-left:10px\n}\n.pop P.type input[data-v-243412c3]{width:23px;height:14px;position:relative;top:3px;margin-right:10px\n}\n.pop P.type input[data-v-243412c3]:nth-child(4){margin-left:15px\n}\n.pop p~p[data-v-243412c3]{margin-top:8px\n}\n.pop .btn-body[data-v-243412c3]{margin-left:130px;margin-top:20px;width:320px;box-sizing:border-box\n}\n.pop button[data-v-243412c3]{width:140px;height:46px;color:#fff;outline:none;border:none;cursor:pointer;font-size:20px\n}\n.pop .sure[data-v-243412c3]{background:#e52e3a\n}\n.pop .sure[data-v-243412c3]:hover{background:#ff3341\n}\n.pop .cancel[data-v-243412c3]{margin-left:34px;background:#ccc\n}\n.pop .cancel[data-v-243412c3]:hover{background:#e52e3a\n}\n.pop i[data-v-243412c3]{position:absolute;top:20px;right:20px;width:20px;height:20px;background:url(" + escape(__webpack_require__(710)) + ") 0 0 no-repeat;cursor:pointer\n}\n.pop2[data-v-243412c3]{width:498px;padding:40px;border-radius:10px;box-sizing:border-box;position:fixed;top:50%;left:50%;transform:translateX(-50%) translateY(-50%);z-index:7;background:#fff;text-align:center\n}\n.pop2.sus p[data-v-243412c3]:first-child{width:44px;height:44px;background-position:-306px -31px\n}\n.pop2 p[data-v-243412c3]:first-child{width:48px;height:48px;margin:38px auto 26px;background:url(" + escape(__webpack_require__(710)) + ") -61px 0 no-repeat\n}\n.pop2 p[data-v-243412c3]:nth-child(2){font-size:20px;color:#666;margin-bottom:48px\n}\n.pop2 button[data-v-243412c3]{width:140px;height:46px;color:#fff;outline:none;border:none;cursor:pointer;font-size:20px\n}\n.pop2 .cancel[data-v-243412c3]{background:#e52e3a\n}\n.pop2 .cancel[data-v-243412c3]:hover{background:#ff3341\n}\n.pop2 .sure[data-v-243412c3]{margin-left:63px;background:#ccc\n}\n.pop2 .sure[data-v-243412c3]:hover{background:#e52e3a\n}\n.pop2 i[data-v-243412c3]{position:absolute;top:20px;right:20px;width:21px;height:21px;background:url(" + escape(__webpack_require__(710)) + ") 0 0 no-repeat;cursor:pointer\n}", ""]);
...
// add the styles to the DOM
var add = __webpack_require__(147).default
var update = add("efcbd2f2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"optionsId\":\"0\",\"vue\":true,\"scoped\":false,\"sourceMap\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!./contract.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"optionsId\":\"0\",\"vue\":true,\"scoped\":false,\"sourceMap\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!./contract.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_contractnone_vue__ = __webpack_require__(858);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_55fe44fa_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_contractnone_vue__ = __webpack_require__(1298);
...
/* scopeId */
var __vue_scopeId__ = "data-v-55fe44fa"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null

var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_contractnone_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_55fe44fa_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_contractnone_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_55fe44fa_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_contractnone_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src\\components\\common\\user\\contractnone.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-55fe44fa", Component.options)
  } else {
    hotAPI.reload("data-v-55fe44fa", Component.options)
  }
...
// add the styles to the DOM
var add = __webpack_require__(147).default
var update = add("5d3b4a60", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"optionsId\":\"0\",\"vue\":true,\"id\":\"data-v-55fe44fa\",\"scoped\":true,\"sourceMap\":false}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./contractnone.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"optionsId\":\"0\",\"vue\":true,\"id\":\"data-v-55fe44fa\",\"scoped\":true,\"sourceMap\":false}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./contractnone.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\ndiv[data-v-55fe44fa]{width:100%;height:100%\n}\ndiv img[data-v-55fe44fa]:first-child{margin:94px auto 36px;display:block\n}\ndiv p[data-v-55fe44fa]:nth-child(2){color:#333\n}\ndiv .toindex[data-v-55fe44fa],div p[data-v-55fe44fa]:nth-child(2){font-size:16px;text-align:center\n}\ndiv .toindex[data-v-55fe44fa]{width:140px;height:38px;line-height:38px;color:#fff;background:#e52e3a;margin:40px auto;display:block\n}", ""]);
  ...
  function() {
    ...
    return _c("div", { staticClass: "container" }, [
      _c("div", [
        _c("img", {
          attrs: {
            src: __webpack_require__(1299),
            alt: ""
          }
        }),
        _vm._v(" "),
        _c("p", [_vm._v("您现在还没有合同主体哦~")])
      ])
    ])
  }
]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-55fe44fa", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
module.exports = "data:image/jpeg;base64,"
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "container" }, [
    _c("p", { staticClass: "contract-head" }, [_vm._v("合同主体")]),
    _vm._v(" "),
    _c(
      "div",
      ...
      [
        ...
        !_vm.contractNone
          ? _c(
              "div",
              { staticClass: "contract-cont clearfix" },
              _vm._l(_vm.contentInfo, function(item, index) {
                return _c("div", { key: index, staticClass: "contract-info" }, [
                  _c("p", [
                    _c("em", [_vm._v("主  体  类  型")]),
                    _c("var", [_vm._v(":")]),
                    item.main_type == 1
                      ? _c("span", [_vm._v("个人")])
                      : _vm._e(),
                  ...
                  _c("p", [
                    item.main_type == 2
                      ? _c("em", [_vm._v("主  体  名  称")])
                      : _c("em", [_vm._v("客     户     名")]),
                    _c("var", [_vm._v(":")]),
                    _c("span", [_vm._v(_vm._s(item.main_title))])
                  ]),
                  _vm._v(" "),
                  _c("p", [
                    item.main_type == 2
                      ? _c("em", [_vm._v("纳税人识别号")])
                      : _c("em", [_vm._v("身  份  证  号")]),
                    _c("var", [_vm._v(":")]),
                    _c("span", [_vm._v(_vm._s(item.company_code))])
                  ]),
                  _vm._v(" "),
                  _c("p", [
                    _c("em", [_vm._v("联     系     人")]),
                  ...
                  _vm._v(" "),
                  _c("p", [
                    _c("em", [_vm._v("手  机  号  码")]),
                    _c("var", [_vm._v(":")]),
                    _c("span", [_vm._v(_vm._s(item.phone))])
                  ]),
                  _vm._v(" "),
                  _c("p", [
                    _c("em", [_vm._v("固  定  电  话")]),
                    _c("var", [_vm._v(":")]),
          ...
          : _vm._e(),
        _vm._v(" "),
        _vm.contractNone ? _c("contractnone") : _vm._e()
      ],
      1
    ),
    _vm._v(" "),
    ...
    _c(
      ...
      [
        ...
        _vm._v(" "),
        _c("p", { staticClass: "type spe" }, [
          _c("span", [_vm._v("主  体  类  型")]),
          _c("var", [_vm._v(":")]),
          _vm._v(" "),
          _c("input", {
            directives: [
        ...
        _c("p", [
          _c("em", [_vm._v("*")]),
          _vm.type == 2
            ? _c("span", [_vm._v("主  体  名  称")])
            : _c("span", [_vm._v("客     户     名")]),
          _c("var", [_vm._v(":")]),
          _c("input", {
            directives: [
              {
                  ...
                  directives: [
                    {
                      name: "show",
                      rawName: "v-show",
                      value: _vm.subNameError,
                      expression: "subNameError"
                    }
                  ]
                },
                [_c("em", [_vm._v("*")]), _vm._v("主体名称不能为空")]
              )
            : _c(
                "strong",
                {
        ...
        _vm.type == 2
          ? _c("p", [
              ...
              _c("input", {
                ...
                attrs: { type: "text" },
                domProps: { value: _vm.recNumbe },
                on: {
                  focus: _vm.recNumberFocusFn,
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.recNumbe = $event.target.value
                  }
                }
              }),
              _vm._v(" "),
                  ...
                  directives: [
                    {
                      name: "show",
                      rawName: "v-show",
                      value: _vm.recNumberError,
                      expression: "recNumberError"
                    }
                  ]
                },
                [_c("em", [_vm._v("*")]), _vm._v("纳税人识别号不能为空")]
              )
            ])
          : _vm._e(),
        _vm._v(" "),
        ...
        _c(
          ...
          [
            _c("em", [_vm._v("*")]),
            _c("span", [_vm._v("所  属  地  区")]),
            _c("var", { staticClass: "speVar" }, [_vm._v(":")]),
            _vm._v(" "),
            _c("v-distpicker", {
              attrs: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-243412c3", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_contract_vue__ = __webpack_require__(857);
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_243412c3_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_contract_vue__ = __webpack_require__(1300);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(213);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-243412c3"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null

var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_contract_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_243412c3_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_contract_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_243412c3_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_contract_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src\\components\\user\\contract.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-243412c3", Component.options)
  } else {
    hotAPI.reload("data-v-243412c3", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common_user_contractnone_vue__ = __webpack_require__(1295);
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        ...
        close: function close() {
            ...
            this.select = {
                ...
                city: '',
                area: ''
            }, this.type = '1', this.subName = '', this.recNumbe = '', this.name = '', this.address = '', this.tel = '', this.phone = '', this.mail = '', this.mask = false;
            this.pop = false;
            this.pop2 = false;
        },
        sure: function sure() {
            ...
            if (this.pophead == "新增合同主体") {
                ...
                if (!(that.subName != '')) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_1__static_js_api_js__["a" /* default */].addContract(data).then(function (res) {
                ...
                var _reg = /^(1[3|4|5|6|7|8|9])[\d]{9}$/g,
                    _that = this;
                if (!(_that.subName != '')) {
                    _that.subNameError = true;
                } else if (!(_that.recNumbe != '')) {
                    _that.recNumberError = true;
                ...
                } else if (!_reg.test(_that.phone)) {
                    this.telError = true;
                } else {
                    var data = {
                        id: _that.id,
                        type: _that.type,
                        subName: _that.subName,
                        recNumbe: _that.recNumbe,
                        name: _that.name,
                        tel: _that.tel,
                        phone: _that.phone,
                    ...
                    __WEBPACK_IMPORTED_MODULE_1__static_js_api_js__["a" /* default */].setContract(data).then(function (res) {
                        if (res.data.code == 200) {
                            _this.close();
                            _this.getCon();
                        }
        ...
        add: function add() {
            //新增合同主体
            this.pophead = "新增合同主体", this.mask = true;
            this.pop = true;
        },
        update: function update(item) {
            //编辑合同主体
            this.pophead = "编辑合同主体";
            this.type = item.main_type, this.subName = item.main_title, this.recNumbe = item.company_code, this.name = item.contact;
            this.tel = item.tel;
        ...
        recNumberFocusFn: function recNumberFocusFn() {
            this.recNumberError = false;
        },
        subNameFocusFn: function subNameFocusFn() {
        ...
        getCon: function getCon() {
            ...
            //获取合同主体
            __WEBPACK_IMPORTED_MODULE_1__static_js_api_js__["a" /* default */].getContract().then(function (res) {
                if (res.data.code == 200) {
                    _this2.contentInfo = res.data.data.list;
                    console.log(_this2.contentInfo);
                    _this2.contentInfo.forEach(function (element) {
                        element.title = element.province + element.city + element.area + element.address;
                    });
                    if (_this2.contentInfo.length != 0) {
                        _this2.contractNone = false;
                    } else {
                        _this2.contractNone = true;
                    }
                    _this2.contentInfo.sort(function (a, b) {
        ...
        setdefault: function setdefault(id) {
            ...
            //设置默认
            __WEBPACK_IMPORTED_MODULE_1__static_js_api_js__["a" /* default */].setContractDefault(id).then(function (res) {
                if (res.data.code == 200) {
                    _this3.getCon();
                }
            });
        ...
        delsure: function delsure() {
            ...
            //确认删除
            __WEBPACK_IMPORTED_MODULE_1__static_js_api_js__["a" /* default */].delContract(this.id).then(function (res) {
                if (res.data.code == 200) {
                    _this4.close();
                    _this4.getCon();
                }
    ...
    components: {
        contractnone: __WEBPACK_IMPORTED_MODULE_2__common_user_contractnone_vue__["a" /* default */]
        //  VDistpicker
    }
});
