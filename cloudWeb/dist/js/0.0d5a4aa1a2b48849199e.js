...
var update = add("156f0ac0", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"optionsId\":\"0\",\"vue\":true,\"scoped\":false,\"sourceMap\":false}!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./seo.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"optionsId\":\"0\",\"vue\":true,\"scoped\":false,\"sourceMap\":false}!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./seo.vue");
...
// module
exports.push([module.i, "\n.bg{padding-bottom:80px;background-color:#fafafa\n}\n.tab{width:930px;border-bottom:1px solid #ccc\n}\n.tab,.tab ul{overflow:hidden\n}\n.tab ul{margin-bottom:-1px\n}\n.tab ul li{float:left;margin-right:80px\n}\n.tab ul li a{display:block;width:100%;font-size:18px;height:50px;line-height:50px;color:#666;cursor:default;box-sizing:border-box\n}\n.tab ul li.cur a,.tab ul li:hover a{color:#e52e3a;border-bottom:2px solid #e52e3a\n}\n.page-channel{overflow:hidden\n}\n.page-channel .banner{width:1920px;margin:0 auto\n}\n.page-channel .container{overflow:hidden\n}\n.page-channel .crumb{padding:16px 0 0;height:38px;box-sizing:border-box;overflow:hidden\n}\n.page-channel .crumb div{float:left\n}\n.page-channel .crumb a,.page-channel .crumb em{display:inline-block;font-size:12px;line-height:22px;color:#666\n}\n.page-channel .crumb a:hover{color:#e52e3a\n}\n.page-channel .crumb .icon{color:#333;vertical-align:middle\n}\n.page-channel .main-right{width:230px;float:right\n}\n.page-channel .main-right>div{width:100%;background-color:#fff;margin-bottom:10px\n}\n.page-channel .mina-left{width:930px\n}\n.my-seris{padding-left:16px;background-color:#f0f0f0;font-size:14px;color:#333;line-height:40px;overflow:hidden\n}", ""]);
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6adaaf78", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_seo_vue__ = __webpack_require__(822);
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6adaaf78_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_seo_vue__ = __webpack_require__(1134);
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_seo_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6adaaf78_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_seo_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6adaaf78_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_seo_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src\\components\\channel\\seo.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6adaaf78", Component.options)
  } else {
    hotAPI.reload("data-v-6adaaf78", Component.options)
  }
...
module.exports = "/images/banner_02.d90eb16.jpg";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__module_seo__ = __webpack_require__(226);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__module_news__ = __webpack_require__(218);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
    asyncData: function asyncData(_ref) {
        if (_ref != undefined) {
            ...
            return Promise.all([store.dispatch(__WEBPACK_IMPORTED_MODULE_11__module_news__["c" /* GET_NEWSRECOMNEWS */]), store.dispatch(__WEBPACK_IMPORTED_MODULE_11__module_news__["a" /* GET_NEWSHOTNEWS */]), store.dispatch(__WEBPACK_IMPORTED_MODULE_10__module_seo__["c" /* GET_SEONEWTITLE */], route), store.dispatch(__WEBPACK_IMPORTED_MODULE_10__module_seo__["a" /* GET_SEONEWDATA */], route)]);
        } else {
            window.location.reload();
        }
    },
    ...
    methods: {
        ...
        dataFun: function dataFun(page) {
            var _this = this;
            var route = this.$route;
            var path = route.path.replace(/\//g, "");
            // 数据列表
            if (this.type == 'seo') {
                Object(__WEBPACK_IMPORTED_MODULE_9__static_js_util_js__["j" /* postFn */])('/content/seoarticle/GetArticlelistByColumnid', { 'columnUrl': this.tid, 'page': page }, function (result) {
                    if (result.data.code == 200) {
                        var newsObj = result.data.data;
                        var newsList = newsObj.data;
                        // _this.newsList = newsList;
                        _this.$store.dispatch(__WEBPACK_IMPORTED_MODULE_10__module_seo__["b" /* GET_SEONEWLIST */], newsList);
                        _this.$store.dispatch("getLastPage", parseInt(newsObj.last_page));
                        _this.$store.dispatch("jumpAction", { page: page });
                    }
                });
            } else {
                Object(__WEBPACK_IMPORTED_MODULE_9__static_js_util_js__["j" /* postFn */])('/content/article/GetArticlelistByColumnid', { 'columnUrl': this.tid, 'page': page }, function (result) {
                    if (result.data.code == 200) {
                        var newsObj = result.data.data;
                        var newsList = newsObj.data;
                        // _this.newsList = newsList;
    ...
    computed: {
        ...
        newsListObj: function newsListObj() {
