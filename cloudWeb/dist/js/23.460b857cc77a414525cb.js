...
var update = add("bee9e96c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"optionsId\":\"0\",\"vue\":true,\"scoped\":false,\"sourceMap\":false}!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./xrNotes.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"optionsId\":\"0\",\"vue\":true,\"scoped\":false,\"sourceMap\":false}!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./xrNotes.vue");
...
// module
exports.push([module.i, "\n.note{position:relative\n}\n.note .float{width:58px;border-top:1px solid #e5e5e5;position:absolute;top:446px;left:50%;margin-left:440px;text-align:center;font-size:12px;color:#666;z-index:5\n}\n.note .float.fixed{top:0;position:fixed\n}\n.note .float.fixed2{top:inherit;position:absolute;bottom:650px\n}\n.note .float .top{display:block;height:24px;padding-top:22px;background:#fff url(" + escape(__webpack_require__(767)) + ") no-repeat center -43px;border:1px solid #e5e5e5;border-top:none;font-weight:700;color:#666\n}\n.note .float .top:hover{color:#fff;background:#e52e3a url(" + escape(__webpack_require__(767)) + ") no-repeat center -88px;border:1px solid #e52e3a;border-top:none\n}\n.note .float ul li{border-left:1px solid #e5e5e5;border-right:1px solid #e5e5e5;background:#fff;cursor:pointer;padding:0 8px\n}\n.note .float ul li span{display:block;line-height:35px;border-bottom:1px dotted #e5e5e5\n}\n.note .float ul li.cur{background:#e52e3a;border-left:1px solid #e52e3a;border-right:1px solid #e52e3a;color:#fff\n}\n.note .float ul li.cur span{border-bottom:1px dotted #e52e3a\n}\n.note .banner{background:url(" + escape(__webpack_require__(1154)) + ") no-repeat top;height:278px\n}\n.note .content{padding-bottom:125px\n}\n.note .content .step{margin-left:125px;border-left:2px solid #e5e5e5;position:relative;min-height:300px\n}\n.note .content .step .empty{height:104px\n}\n.note .content .step .ico{height:43px;width:50px;position:absolute;bottom:-42px;left:-16px;background:url(" + escape(__webpack_require__(767)) + ") no-repeat\n}\n.note .content .step .list{padding-left:28px\n}\n.note .content .step .list .time{height:88px;line-height:88px;font-family:Arial;font-size:42px;font-weight:700;position:relative\n}\n.note .content .step .list .time em{display:block;position:absolute;width:14px;height:14px;border-radius:50%;background:#fff;top:34px;left:-38px;border:2px solid #e5e5e5\n}\n.note .content .step .list.cur .time{color:#e52e3a\n}\n.note .content .step .list.cur .time em{background:#e52e3a;border:2px solid #e52e3a\n}\n.note .content .step .list .option{padding-bottom:35px;line-height:34px\n}\n.note .content .step .list .option li .msg,.note .content .step .list .option li em{float:left;line-height:34px\n}\n.note .content .step .list .option li em{width:65px;text-align:right;font-weight:700;height:34px;overflow:hidden;text-overflow:ellipsis\n}\n.note .content .step .list .option li .msg{color:#999;font-size:16px;padding-left:18px\n}\n.note .content .step .list .option li .msg span{display:block;line-height:34px\n}", ""]);
...
module.exports = "/images/banner_bg.eed7cc6.jpg";
...
var render = function() {
  ...
  return _c(
    ...
    [
            ...
            [
              ...
              _vm._l(_vm.list, function(item, index) {
                return _c(
                  "div",
                  {
                    class: { list: true, cur: _vm.yIndex == index },
                    attrs: { id: "year" + item.node }
                  },
                  [
                    _c("div", { staticClass: "time" }, [
                      _c("em"),
                      _vm._v(" "),
                      _c("span", [_vm._v(_vm._s(item.node))])
                    ]),
                    _vm._v(" "),
                    _c("div", { staticClass: "option" }, [
                      _c(
                        "ul",
                        _vm._l(item.event, function(i, ind) {
                          return _c("li", [
                            _c("div", { staticClass: "clearfix" }, [
                              _c("em", [_vm._v(_vm._s(i.title))]),
                              _vm._v(" "),
                              _c("div", { staticClass: "msg" }, [
                                _c("span", [_vm._v(_vm._s(i.content))])
                              ])
                            ])
                          ])
                        })
      ...
      _c(
        "div",
        { class: { float: true, fixed: _vm.fixed, fixed2: _vm.fixed2 } },
        [
          _c(
            "ul",
            _vm._l(_vm.yearList, function(item, index) {
              return _c(
                "li",
                {
                  class: { cur: _vm.yIndex == index },
                  on: {
                    click: function($event) {
                      _vm.linkToFn("#year" + item, index)
                    }
                  }
                },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-22a4b650", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_xrNotes_vue__ = __webpack_require__(827);
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_22a4b650_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_xrNotes_vue__ = __webpack_require__(1155);
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_xrNotes_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_22a4b650_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_xrNotes_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_22a4b650_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_xrNotes_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src\\components\\about\\xrNotes.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-22a4b650", Component.options)
  } else {
    hotAPI.reload("data-v-22a4b650", Component.options)
  }
...
module.exports = "data:image/png;base64,"
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_common_top_vue__ = __webpack_require__(598);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__module_xrNotes__ = __webpack_require__(230);
...
/* harmony default export */ __webpack_exports__["a"] = ({
	asyncData: function asyncData(_ref) {
		if (_ref != undefined) {
			...
			return Promise.all([store.dispatch(__WEBPACK_IMPORTED_MODULE_5__module_xrNotes__["a" /* GET_XRNOTESLIST */]), store.dispatch(__WEBPACK_IMPORTED_MODULE_5__module_xrNotes__["b" /* GET_XRNOTESYEARLIST */])]);
		} else {
			window.location.reload();
		}
	},
	...
	methods: {
		backTop: function backTop() {
			Object(__WEBPACK_IMPORTED_MODULE_4__static_js_util_js__["b" /* backTop */])(this);
		},
		linkToFn: function linkToFn(selector, index) {
			var that = this;
	...
	mounted: function mounted() {
		...
		window.onscroll = function () {
			...
			try {
				for (var _iterator = that.yearList.entries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
