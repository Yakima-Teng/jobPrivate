...
var update = add("e49cdf70", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"optionsId\":\"0\",\"vue\":true,\"scoped\":false,\"sourceMap\":false}!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./newsDetail.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"optionsId\":\"0\",\"vue\":true,\"scoped\":false,\"sourceMap\":false}!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./newsDetail.vue");
...
// module
exports.push([module.i, "\n.bg{padding-bottom:80px;background-color:#fafafa\n}\n.page-detail{overflow:hidden\n}\n.page-detail .main{padding-top:26px;overflow:hidden\n}\n.page-detail .main-right{width:230px;float:right\n}\n.page-detail .main-right>div{width:100%;background-color:#fff;margin-bottom:10px\n}\n.page-detail .mina-left{width:930px\n}\n.page-detail .mina-left .article h2{font-size:24px;line-height:1;text-align:center\n}\n.page-detail .mina-left .article .info{margin-top:30px;font-size:12px;line-height:14px;height:14px;text-align:center;overflow:hidden\n}\n.page-detail .mina-left .article .info span{display:inline-block;margin-right:27px;color:#999\n}\n.page-detail .mina-left .article .info span.author,.page-detail .mina-left .article .info span.scan{margin-top:-8px\n}\n.page-detail .mina-left .article .info span .icon{color:#999;font-size:13px;vertical-align:middle\n}\n.page-detail .mina-left .article .info span .icon.icon-scan,.page-detail .mina-left .article .info span .icon.icon-user{font-size:30px\n}\n.page-detail .mina-left .article .info span .icon.icon-shizhong{margin-right:7px\n}\n.page-detail .mina-left .article .article-body{margin-top:28px;padding:23px 0;border-top:1px dashed #ccc;border-bottom:1px dashed #ccc\n}\n.page-detail .mina-left .article .article-body p{font-size:14px;line-height:26px;margin-bottom:10px\n}\n.page-detail .mina-left .article .article-body p img{margin:0 auto\n}\n.page-detail .mina-left .article .article-body em,.page-detail .mina-left .article .article-body i{font-style:italic\n}\n.page-detail .mina-left .article .article-body b,.page-detail .mina-left .article .article-body strong{font-weight:700\n}\n.page-detail .mina-left .article .tag{margin-top:20px;font-size:14px;line-height:32px\n}\n.page-detail .mina-left .article .tag .share{float:right\n}\n.page-detail .mina-left .article .tag .share .icon-share,.page-detail .mina-left .article .tag .share .social-share-icon{display:inline-block;font-size:32px;vertical-align:top;margin-right:10px\n}\n.page-detail .mina-left .article .tag .share .icon-share{color:#9b9b9b\n}\n.page-detail .mina-left .article .tag .share .social-share{display:inline-block\n}\n.page-detail .mina-left .article .tag .share .social-share .icon-weibo{color:#e45656\n}\n.page-detail .mina-left .article .tag .share .social-share .icon-qq{color:#4dafea\n}\n.page-detail .mina-left .article .tag .share .social-share .icon-wechat{position:relative\n}\n.page-detail .mina-left .article .tag .share .social-share .icon-wechat:before{color:#3eb135;content:\"\\E65B\"\n}\n.page-detail .mina-left .article .tag .share .social-share .icon-wechat:hover .wechat-qrcode{display:block\n}\n.page-detail .mina-left .article .tag .share .social-share .icon-wechat .wechat-qrcode{display:none;background:#fff;color:#333;border:1px solid #eee;height:220px;position:absolute;right:-100px;bottom:5px;width:220px;z-index:40\n}\n.page-detail .mina-left .article .tag .share .social-share .icon-wechat .wechat-qrcode h4{font-size:16px;line-height:50px;text-align:center\n}\n.page-detail .mina-left .article .tag .share .social-share .icon-wechat .wechat-qrcode .qrcode img{display:block;margin:0 auto\n}\n.page-detail .mina-left .article .tag .share .social-share .icon-wechat .wechat-qrcode .help{padding:10px 0 0;text-align:center\n}\n.page-detail .mina-left .article .tag .share .social-share .icon-wechat .wechat-qrcode .help p{font-size:12px;line-height:20px\n}\n.page-detail .mina-left .article .tag .share .social-share .icon-qzone{color:#eecf3d;margin-right:0\n}\n.page-detail .mina-left .article .tag .share .social-share .icon-qzone:before{content:\"\\E6E4\"\n}\n.page-detail .mina-left .article .tag .label{line-height:inherit;color:#999\n}\n.page-detail .mina-left .article .tag .label span{color:#666;margin-right:18px\n}\n.page-detail .mina-left .article .tag .label span:hover{color:#e52e3a\n}\n.page-detail .mina-left .page-num{margin-top:53px;display:flex;justify-content:space-between;overflow:hidden;color:#999\n}\n.page-detail .mina-left .page-num a{color:#666\n}\n.page-detail .mina-left .page-num a:hover{color:#e52e3a\n}\n.page-detail .mina-left .page-num>div{font-size:14px;line-height:30px;width:450px\n}\n.my-seris{padding-left:16px;background-color:#f0f0f0;font-size:14px;color:#333;line-height:40px;overflow:hidden\n}", ""]);
    ...
    [
      ...
      _c("div", { staticClass: "bg" }, [
        _vm.article != null
          ? _c(
              "div",
              { staticClass: "w1190 container" },
              [
                _vm.nav.length
                  ? _c("crumb", { attrs: { nav: _vm.nav, url: _vm.firstUrl } })
                  : _vm._e(),
                _vm._v(" "),
                      ...
                      ? _c("div", { staticClass: "article" }, [
                          ...
                          _c("p", { staticClass: "info" }, [
                            _c("span", { staticClass: "author" }, [
                              ...
                              _vm._v("作者：" + _vm._s(_vm.article.author))
                            ]),
                            _c("span", { staticClass: "time" }, [
                              _c("i", { staticClass: "icon icon-shizhong" }),
                              _vm._v(_vm._s(_vm.article.create_time))
                            ]),
                            _c("span", { staticClass: "scan" }, [
                              _c("i", { staticClass: "icon icon-scan" }),
                              _vm._v(_vm._s(_vm.article.click) + "次浏览")
                            ])
                          ]),
                          _vm._v(" "),
                          _c("div", {
                          ...
                          _c("div", { staticClass: "tag" }, [
                            ...
                            _vm._v("标签：\r\n                            "),
                            _c("span", [_vm._v(_vm._s(_vm.article.tags))])
                          ])
                        ])
                      : _vm._e(),
                    _vm._v(" "),
                    _c("div", { staticClass: "page-num" }, [
                      _vm.article.front != null &&
                      _vm.article.front.title != undefined &&
                      _vm.article.front.title != ""
                        ? _c(
                            "div",
                            { staticClass: "prev" },
                            [
                              _vm._v("上一篇："),
                              _vm.firstUrl.indexOf("news") == -1
                                ? _c(
                                    "router-link",
                                    {
                                      attrs: {
                                        ...
                                        to: {
                                          path:
                                            "/" +
                                            _vm.article.front.parent_columnUrl +
                                            "/" +
                                            _vm.article.front.id
                                        }
                                      },
                                      nativeOn: {
                                        click: function($event) {
                                          _vm.getData(_vm.article.front.id)
                                        }
                                      }
                                    },
                                    [_vm._v(_vm._s(_vm.article.front.title))]
                                  )
                                : _c(
                                    "router-link",
                                    {
                        ...
                        : _vm._e(),
                      _vm._v(" "),
                      _vm.article.after != null &&
                      _vm.article.after.title != undefined &&
                      _vm.article.after.title != ""
                        ? _c(
                            "div",
                            { staticClass: "next" },
                            [
                                    ...
                                    "router-link",
                                    {
                                      attrs: {
                                        ...
                                        to: {
                                          path:
                                            "/" +
                                            _vm.article.after.parent_columnUrl +
                                            "/" +
                                            _vm.article.after.id
                                        }
                                      },
                                      nativeOn: {
                                        click: function($event) {
                                          _vm.getData(_vm.article.after.id)
                                        }
                                      }
                                    },
                                    [_vm._v(_vm._s(_vm.article.after.title))]
                                  )
                                : _c(
                                    "router-link",
                                    {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7f5da226", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_newsDetail_vue__ = __webpack_require__(820);
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7f5da226_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_newsDetail_vue__ = __webpack_require__(1131);
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7f5da226_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_newsDetail_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7f5da226_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_newsDetail_vue__["b" /* staticRenderFns */],
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7f5da226", Component.options)
  } else {
    hotAPI.reload("data-v-7f5da226", Component.options)
  }
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__common_top_vue__ = __webpack_require__(598);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__common_channel_news_vue__ = __webpack_require__(725);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__common_search_list_vue__ = __webpack_require__(711);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__common_search_crumb_vue__ = __webpack_require__(732);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__module_newsDetail__ = __webpack_require__(225);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__module_news__ = __webpack_require__(218);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__static_js_util_js__ = __webpack_require__(6);
var _computed;
...
/* harmony default export */ __webpack_exports__["a"] = ({
    asyncData: function asyncData(_ref) {
        if (_ref != undefined) {
            ...
            return Promise.all([store.dispatch(__WEBPACK_IMPORTED_MODULE_10__module_news__["c" /* GET_NEWSRECOMNEWS */]), store.dispatch(__WEBPACK_IMPORTED_MODULE_10__module_news__["a" /* GET_NEWSHOTNEWS */]), store.dispatch(__WEBPACK_IMPORTED_MODULE_9__module_newsDetail__["a" /* GET_NEWSDETAILTITLE */], route)]);
        } else {
            window.location.reload();
        }
    },
    ...
    }, _defineProperty(_computed, 'article', function article() {
        return this.$store.state.serviceNewsDetail.newDetailArticle;
    }), _defineProperty(_computed, 'nav', function nav() {
        return this.$store.state.serviceNewsDetail.newDetailNav;
    }), _computed),
    beforeMount: function beforeMount() {
        // 只会在浏览器执行 
        this.$options.components.sharePart = function () {
            return __webpack_require__.e/* import() */(38/* duplicate */).then(__webpack_require__.bind(null, 821));
        };
        var _this = this;
    ...
    components: {
        ...
        news: __WEBPACK_IMPORTED_MODULE_6__common_channel_news_vue__["a" /* default */],
        newsList: __WEBPACK_IMPORTED_MODULE_7__common_search_list_vue__["a" /* default */],
        crumb: __WEBPACK_IMPORTED_MODULE_8__common_search_crumb_vue__["a" /* default */]
        // sharePart
    }
});
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(94)))
